 ...
 * Information command
 *
 * Gets executed when a user first informations using the bot.
 */
class InformationCommand extends SystemCommand
{
	/**
	 * @var string
	 */
	 ...
	 * @var string
	 */
	protected $description = 'Information command';

	/**
	 * @var string
	 */
	protected $usage = '/information';
